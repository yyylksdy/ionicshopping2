...
.factory('fireBaseData', function($firebase) {
	var ref = new Firebase("https://udelivery-5f0a6.firebaseio.com/"),
    refCart = new Firebase("https://udelivery-5f0a6.firebaseio.com/cart"),
    refUser = new Firebase("https://udelivery-5f0a6.firebaseio.com/users"),
    refCategory = new Firebase("https://udelivery-5f0a6.firebaseio.com/category"),
    refOrder = new Firebase("https://udelivery-5f0a6.firebaseio.com/orders"),
    refFeatured = new Firebase("https://udelivery-5f0a6.firebaseio.com/featured"),
    refMenu = new Firebase("https://udelivery-5f0a6.firebaseio.com/menu");
  return {
    ref: function() {
      return ref;
    },
